...
const clientSchema = new mongoose.Schema({
    ...
    bufferTime: {type: Number, default: 0}, // buffer between appointments
    maxAdvanceBooking: {type: Number, default: 30}, // days in advance
    minAdvanceBooking: {type: Number, default: 1}, // minimum hours in advance
    isActive: {type: Boolean, default: true},
    subscriptionPlan: {type: String, default: "free"}, // free, premium
